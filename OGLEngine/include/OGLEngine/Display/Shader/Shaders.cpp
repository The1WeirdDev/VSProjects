...
void Shaders::Init() {
	const char* vertex_data = "#version 330 core \nuniform mat4 projection_matrix; uniform mat4 transformation_matrix; uniform mat4 view_matrix; in vec3 position; void main(){gl_Position = projection_matrix * transformation_matrix * view_matrix * vec4(position, 1.0);}";
	...
	basic_mesh_3d_shader.uniforms.push_back(basic_mesh_3d_shader.GetUniformLocation("view_matrix"));
}
